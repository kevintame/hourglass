...
export default async function ProjectsPage() {
  ...
  return <><PageHeader eyebrow="Work" title="Projects"/><div className="content"><div className="grid grid-2">
    ...
    <section><div className="section-head"><div><div className="eyebrow">New</div><h2>Create a project</h2></div></div><form action={createProjectAction} className="card card-pad grid">
      ...
      <button className="btn btn-primary" style={{justifySelf:"start"}}><Plus size={15}/> Create project</button>
    </form></section>
  </div></div></>;
}
